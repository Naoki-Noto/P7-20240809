...
for random_state in range(10):
    ...
    for t in ["Yield_CO_s", "Yield_CO_l", "Yield_CO_cl"]:
        ...
        results.append({'target': t, 'r2_test': r2_test_score})
        results_history.append({'target': (t,random_state), 'best_epoch':best_epoch,'train_loss_history': train_loss_history_retry, 'valid_loss_history': valid_loss_history_retry, })
    n += 1
